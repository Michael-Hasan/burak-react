...
import { Order, OrderInquiry } from "../../../lib/data/types/orders";
...
const actionDispatch = (dispatch: Dispatch) => ({
  ...
  setFinishedOrderss: (data: Order[]) => dispatch(setFinishedOrders(data)),
});

export default function OrdersPage() {
  const { setPausedOrders, setProcessOrders, setFinishedOrderss } =
  ...
  useEffect(() => {
    ...
    order
      ...
      .then((data) => setFinishedOrderss(data))
      .catch((err) => console.error(err));
